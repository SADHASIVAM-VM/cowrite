  ...
  const testimonials = [
    {
      name: "Emily Johnson",
      feedback:
        "CoWrite Blog always keeps me updated with the latest tech trends. I love the insightful and easy-to-understand articles!",
      rating: 5,
    },
    {
      name: "Mark Thompson",
      feedback:
        "A fantastic blog with a great mix of tech, lifestyle, and personal growth content. Highly recommended!",
      rating: 5,
    },
    {
      name: "Sophia Martinez",
      feedback:
        "The lifestyle hacks on CoWrite have genuinely improved my daily routine. It's my go-to blog for useful tips!",
      rating: 4.5,
    },
    {
      name: "Daniel Lee",
      feedback:
        "I appreciate the fresh perspectives on CoWrite. The personal growth stories are truly inspiring!",
      rating: 5,
    },
    {
      name: "Jessica Brown",
      feedback:
        "CoWrite Blog is well-organized and easy to navigate. The content is always relevant and engaging!",
      rating: 4.5,
    },
    {
      name: "Michael Davis",
      feedback:
        "I found so many practical tips on CoWrite. The articles are well-researched and incredibly helpful!",
      rating: 5,
    },
    {
      name: "Rachel Wilson",
      feedback:
        "CoWrite is my favorite blog! The content is diverse, and I always learn something new.",
      rating: 5,
    },
    {
      name: "David Anderson",
      feedback:
        "I love how CoWrite presents complex topics in a simple and engaging way. It makes learning enjoyable!",
      rating: 4.5,
    },
    {
      name: "Olivia Carter",
      feedback:
        "This blog is a must-read for anyone looking to stay informed and motivated. Keep up the great work!",
      rating: 5,
    },
    {
      name: "Ethan Robinson",
      feedback:
        "CoWrite Blog stands out with its quality content and fresh insights. I look forward to every new post!",
      rating: 5,
    },
  ];
    ...
    <Navbar/>
      <div className="space-y-10 md:space-y-16 ">
        ...
        <section className="text-white flex flex-col md:flex-row items-center relative py-16  text-center  herosvg">
          ...
          <div className="z-10 px-1  flex flex-col  items-center">
            ...
            <p className="text-sm md:text-[16px] px-1 text-[#f4f4f4] lg:w-[70%] lg:text-lg mb-6  text-justify">
              ...
              platform is designed to spark your imagination. Dive into a world
              of insightful articles, thought-provoking ideas, and a vibrant
        ...
        <section className=" px-2 md:px-5 flex flex-col md:flex-row items-center ">
          ...
          <div className="md:w-1/2 md:order-1 space-y-4">
            ...
            <p className="text-sm md:text-[16px] opacity-70 ">
              CoWrite Blog is a place where you can discover interesting and
              useful content on various topics like tech, lifestyle, and
              personal growth. Whether you're looking for the latest trends,
              helpful tips, or inspiring stories, we’ve got you covered. Our
              goal is to share knowledge in a simple and engaging way to keep
        ...
        <section className=" md:px-5 px-2 py-5">
          ...
          <div className="w-full space-y-4">
            ...
            <p className="text-sm opacity-70 md:text-[16px] mb-6 ">
              CoWrite is a platform designed for those who love to explore new
              ...
              {[
                {
                  ...
                  desc: "Explore how artificial intelligence is shaping the future of technology.",
                },
                {
                  img: productivity,
                  title: "Productivity Hacks",
                  desc: "Learn how to maximize your efficiency and achieve more each day.",
                },
                {
                  img: health,
                  title: "Healthy Living Tips",
                  desc: "Simple steps to maintain a balanced and healthy lifestyle.",
                },
                {
                  img: Construction,
                  title: "The Future India!",
                  desc: "Evaluation of Indian Construction and Architecture.",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="border p-1 rounded-lg overflow-hidden shadow-lg"
                >
                  <img
                    loading="lazy"
                    src={item.img}
                    alt={item.title}
                    className="object-cover w-full h-48 md:h-56 lg:h-64 rounded-lg"
                  />
                  <div className="p-4">
        ...
        <section className="py-16 md:px-5 px-2">
          <h1 className="text-2xl md:text-4xl lg:text-6xl hq mb-4 ">
            Testimonials
          </h1>
        ...
        <section className=" py-16 md:px-5 px-2">
          <div className="max-w-4xl  mx-auto">
            <h2 className="text-2xl md:text-4xl lg:text-6xl hq mb-6 md:text-center ">
              FAQs
            </h2>
